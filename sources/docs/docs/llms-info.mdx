---
title: Export of the Documentation for LLMs
              ...
              oneOf:
                - title: ConfirmPaymentRequest
                  ...
                  properties:
                    ...
                    allow_unsafe_owner:
                      type: boolean
                      description: Optional flag to allow an unsafe owner address.
                    ...
                    simulate_withdrawal:
                      type: boolean
                      description: Simulate a withdrawal for testing purposes.
    ...
    WithdrawPaymentAuthorizationResponse:
      ...
      properties:
        ...
        withdraw_authorization:
          type: string
          description: |
            Authorization data to sign. For eip712, this is a JSON string to parse and pass to signTypedData. For erc191, pass this string directly to signMessage.
        state_token:
          type: string
