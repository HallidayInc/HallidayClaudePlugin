...
- Poll the `GET /payments` endpoint using the payment ID to monitor the progress of the onramp until it completes onchain.
...
- Poll the `GET /payments` endpoint using the payment ID to monitor the progress of the swap until it completes onchain.
