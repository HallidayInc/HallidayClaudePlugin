...
1. **Obtain API Credentials**: [Get a free API key at dashboard.halliday.xyz](https://dashboard.halliday.xyz/)
...
For detailed implementation examples, see the [API Quickstart](/pages/api-quickstart) guide. [Get a free API key at dashboard.halliday.xyz](https://dashboard.halliday.xyz/).
