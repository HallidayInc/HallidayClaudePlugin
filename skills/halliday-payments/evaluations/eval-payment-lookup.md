...
2. Claude identifies this as a payment lookup request
3. Claude reads `reference/payment-lookup-guide.md`
...
8. If recovery is needed, Claude explains both options (retry and withdraw) with specific steps
