...
2. Claude presents the initialization menu (or routes directly from the question)
3. Claude identifies this as an integration check request
...
10. Claude reports findings with PASS / MISSING / WARNING and severity levels
11. For MISSING items, Claude explains the edge case and provides implementation guidance
